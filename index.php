    ...
    <main>
        <section class="hero">
            <div class="content">
                ...
                <a href="/planner" class="cta-button">Start Planning <i class="fas fa-arrow-right"></i></a>
            </div>
        </section>
        ...
        <section class="features">
            ...
            <div class="features-grid">
                <div class="feature-card">
                    ...
                    <p class="feature-description">See your garden come to life with realistic 3D rendering and real-time preview of your designs.</p>
                </div>
                <div class="feature-card">
                    <i class="fas fa-seedling feature-icon"></i>
                    <h3 class="feature-title">Plant Library</h3>
                    <p class="feature-description">Access thousands of plants with detailed information about growth requirements and maintenance.</p>
                </div>
                <div class="feature-card">
                    <i class="fas fa-cloud-sun feature-icon"></i>
                    <h3 class="feature-title">Climate Analysis</h3>
                    <p class="feature-description">Get personalized plant recommendations based on your local climate and growing conditions.</p>
                </div>
            </div>
        </section>
